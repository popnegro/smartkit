const SCREENS=[
  {id:1,lat:-32.8931,lng:-68.8449,n:'Peatonal Sarmiento',b:'Microcentro',dir:'Peatonal Sarmiento 150',dim:'8x4 m',res:'Full HD',imp:'52.000',precio:95000,tipo:'Peatonal',e:'PS',g:'linear-gradient(135deg,#075985,#0f766e)',video:'./assets/videos/peatonal-sarmiento.mp4', provider: 'SmartKit', active: true},
  {id:2,lat:-32.8890,lng:-68.8442,n:'San Martin & Belgrano',b:'Microcentro',dir:'Av. San Martin 600',dim:'6x3 m',res:'Full HD',imp:'38.000',precio:80000,tipo:'Vehicular',e:'SB',g:'linear-gradient(135deg,#0f766e,#14532d)',video:'./assets/videos/sarmiento-y-belgrano.mp4', active: true},
  {id:3,lat:-32.8908,lng:-68.8388,n:'Plaza Independencia',b:'Microcentro',dir:'Plaza Independencia Este',dim:'10x5 m',res:'4K UHD',imp:'68.000',precio:140000,tipo:'Mixto',e:'PI',g:'linear-gradient(135deg,#0369a1,#4f46e5)',video:'./assets/videos/plaza-independencia.mp4', active: true},
